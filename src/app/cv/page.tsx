...
import { User, Briefcase, Award, FileText, ChevronLeft, ChevronRight, CreditCard, CheckCircle2, Trash2 } from 'lucide-react';
    ...
    <div className="flex flex-col h-screen bg-[#F8FAFC] text-slate-900">
      <header className="flex-none flex items-center justify-between px-8 py-4 bg-white border-b border-slate-200 shadow-sm z-20">
        <Link href="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
          ...
          <h1 className="text-xl font-bold tracking-tight">かんたん履歴書 <span className="text-slate-400 font-normal">職務経歴書</span></h1>
        </Link>
